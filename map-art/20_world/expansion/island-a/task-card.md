...
Primary request: Create one new standalone outer island that unmistakably belongs to the same “Echoes” knowledge world. This is Island A, a broad crescent-shaped island with a sheltered inner bay, two gently stepped uplands, a winding stream, terraced gardens, a modest harbor, several refined neutral civic buildings, small bridges, paths, groves, and ordinary settlements. It must be a complete polished place but must not imply economy, history, technology, or any other fixed category.
...
Composition/framing: one complete island only, approximately 30-degree orthographic top-down view, long axis diagonal from upper-left to lower-right, generous clear padding on every side, no crop. Match the reference building scale and visible-detail density. Thin ivory-white cliff/model sides around the full coast.
Lighting/mood: same soft upper-left daylight as the references, airy, quiet, refined, low saturation.
Color palette: warm parchment stone, muted sage, pale wheat, restrained dusty rose accents, small pale-cyan waterways. No category-dominant color.
...
- `web/public/map-runtime/world/expansion/island-a/`：运行时 LOD1 WebP。
