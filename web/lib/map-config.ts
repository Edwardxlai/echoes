...
export const WORLD_SCENE: MapScene = {
  ...
  items: [
    ...
    item({
      ...
      x: 10,
      y: 64,
      asset: "/map-runtime/unknown-sea/unknown-sea-world-region-terrain-v01.png",
      route: "/collection/unknown-sea",
      cameraZoom: 1.34,
    ...
    item({
      ...
      y: 36,
      asset:
        "/map-runtime/world/expansion/island-b/terrain/world_expansion-island-b_terrain_default_lod1_v01.webp",
      route: "/category/sci",
      cameraZoom: 1.34,
...
export const REGION_SCENES: Record<string, MapScene> = {
  ...
  soc: {
    ...
    type: "region",
    camera: { position: [50, 50, 88], target: [50, 50, 0], zoom: 1 },
    environment: { asset: "environment/region-soc", effects: ["water", "clouds", "parallax"] },
    items: [],
  },
  sci: {
    id: "region-sci",
...
export const ARCHIPELAGO_SCENES: Record<string, MapScene> = {
  c1: {
    ...
    environment: { asset: "environment/archipelago-eco", effects: ["water", "mist"] },
    items: [
  ...
  c2: {
    ...
    type: "archipelago",
    camera: { position: [50, 50, 82], target: [50, 50, 0], zoom: 1 },
    environment: { asset: "environment/archipelago-eco", effects: ["water"] },
    items: [
  ...
  c4: {
    ...
    type: "archipelago",
    camera: { position: [50, 50, 82], target: [50, 50, 0], zoom: 1 },
    environment: { asset: "environment/archipelago-tech", effects: ["water", "parallax"] },
    items: [
